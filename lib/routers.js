    ...
    profile: {
        ...
        portfolio: [{
            ...
            description: 'New platform where you can find and share your favorite sport locations.<br/><br/>' +
                         'A social media platform for sports enthusiasts, enabling fast sharing of present activities.<br/><br/>' +
            ...
            description: 'Crowd knowledge media that enables online collaboration with your fellow students with.<br/><br/>' +
                         'Ask questions online and get answers real-time with Examplex.<br/><br/>' +
                         'A centralized media that help eliminate the redundant questions, for students to focus on the important ones.',
            technologies: [
                Technologies.AWS,
                Technologies.DIGITALOCEAN,
                Technologies.METEOR,
            ...
            description: 'Simpel webshop design made for my friends to be hosted on Shopify.<br/><br/>' +
                         'Buy mobility equipment to ease the muscular restitution process.',
            technologies: [
                Technologies.BOOTSTRAP,
                Technologies.MYSQL,
                Technologies.PHP
            ...
            description: 'Huge project for the Danish Goverment/Tax Department that allow Danish citizents to declare their self-assessments.<br/><br/>' +
                         'Working on the project as developer focusing on improving the build and deployment process.<br/><br/>' +
                         'The final results showed 500% faster system, with a build and deployment time of 3 minutes',
            technologies: [
                Technologies.ANGULAR,
                Technologies.BOOTSTRAP,
                Technologies.DOTNET,
            ...
            description: 'Large system registering all Danes salery earn when working. ' +
                         'Therefore high performance is a critical issue leaving no errors to be made.<br/><br/>' +
                         'Worked on the project as developer focusing on testing and verfification, creating automated stress-, load- and regressiontests.',
            technologies: [
                Technologies.JAVA,
                Technologies.MAINFRAME,
                Technologies.MYSQL,
            ...
            description: 'Huge system with multiple govermental institutions interfaced to KMD Momentum.<br/><br/>' +
                         'The system collects job offers from multiple company databases. ' +
                         'The system gives Danish municipalities/social workers the oppertunity to find jobs for unemployed citizents.<br/><br/>' +
                         'By Danish Law, all unemployed citizents receiving money from the goverment should be activated by seeking job or get educated.<br/><br/>' +
                         'Worked on the project as full-stack developer, improving the system performance, designing, analyzing etc.',
            technologies: [
                Technologies.ANGULAR,
            ...
            description: 'Fun private project to give the public a transparent overview of the economic services provided by the Danish Government to DK/EU citizents.',
            technologies: [
                Technologies.HTML,
                Technologies.JAVASCRIPT,
                Technologies.JSON
